<template>
    <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
        style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;" viewBox="0 0 512 512">
        ...
        <path
            ...
            class="fill-white" />
        <path d="M248.54 364.76v41.33h33v-43.5l-33 2.17Z" class="fill-primary-medium" />
        <g>
            <path d="M263.54 364.76v41.33h33v-43.5l-33 2.17Z" class="fill-white" />
            <path d="M263.54 364.76v41.33h33v-43.5l-33 2.17Z" class="fill-primary/50" />
        </g>
        <path d="m207.07 422.7 115.6-.2v-12.8c.06-3.48-1.4-5.54-4.4-5.8l-105.8-.4c-3.36 0-5.3 2.14-5.3 5.5l-.1 13.7Z"
            class="fill-primary-medium" />
        <path d="m223.07 422.7 115.6-.2v-12.8c.06-3.48-1.4-5.54-4.4-5.8l-105.8-.4c-3.36 0-5.3 2.14-5.3 5.5l-.1 13.7Z"
        ...
        <path
            ...
            class="fill-primary-light" />
        <circle cx="162.28" cy="353.08" r="4.53" class="fill-primary-medium" />
        <path d="m151.46 142.26-2.5 198 261.5 2.5 1.5-194.5-260.5-6Z" class="fill-white" />
        <path
            ...
            opacity=".8" class="fill-primary-extralight" />
        <g class="q q-1">
            <path
