                ...
                projects: [
                    {
                        ...
                        title: "派蒙浏览器扩展",
                        description: "在浏览器中查看原神树脂信息，不错的UI&还行的本地化支持，你会喜欢的。",
                    ...
                    },
                    {
                        ...
                        title: "真值表生成器",
                        description: "根据输入的逻辑表达式生成真值表，是玩Antlr时的即兴作品。",
                    ...
                    },
                    {
                        ...
                        title: "图片LSB查看器",
                        description: "在线查看图片通道的LSB信息，没什么用，功能没有StegSolve丰富。",
                    ...
                    },
                    {
                        ...
                        title: "DouBoard",
                        description: "支持压感的在线白板，只是当时觉得微软白板很好看，临摹了一下。",
                ...
                projects: [
                    {
                        ...
                        title: "GHAuth",
                        description: "「基佬之家」MC服务器自用的身份认证系统。开源项目同名，拥有完整的Yggdrasil协议实现。",
